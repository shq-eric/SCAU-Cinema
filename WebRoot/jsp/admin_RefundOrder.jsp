                ...
                <ul class="nav side-menu">
                  ...
                  <li><a><i class="fa fa-search"></i> 信息查询 <span class="fa fa-chevron-down"></span></a>
                    <ul class="nav child_menu" style="display: block;">
                      ...
                      <li class="current-page"><a href="<%=basePath1 %>refundorder/showrefundorder.do">退票订单</a></li>
                    </ul>
                  </li>
                ...
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <table id="datatable" class="table table-striped table-bordered">
                      <thead>
                        <tr>
                          <th>RefundOrder_Id</th>
                          <th>RefundOrder_CustomerId</th>
                          <th>RefundOrder_CustomerName</th>
                          <th>RefundOrder_CustomerTel</th>
                          <th>RefundOrder_Price</th>
                          <th>Ticket_Num</th>
                          <th>RefundOrder_Reason</th>
                          <th>RefundOrder_Status</th>
                      ...
                      <tbody>
                      <c:forEach items="${refundorders }" var="refundorder">
                        <tr>
                          <!-- 字体大小 -->
                          <th width="15%" style="font-size:20px;">${refundorder.getRefundOrderId()}</th>
                          <th width="15%" style="font-size:20px;">${refundorder.getRefundOrderCustomerId()}</th>
                          <th width="10%" style="font-size:15px;">${refundorder.getRefundOrderCustomerName()}</th>
                          <th width="10%" style="font-size:15px;">${refundorder.getRefundOrderCustomerTel()}</th>
                          <th width="5%" style="font-size:15px;">${refundorder.getRefundOrderPrice()}</th>
                          <th width="5%" style="font-size:15px;">${refundorder.getTicketNum()}</th>
                          <th style="font-size:15px;">${refundorder.getRefundOrderReason()}</th>
                          <th style="font-size:15px;">${refundorder.getRefundOrderStatus()}</th>
                          <!-- <th width="132px">
